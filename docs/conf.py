...
version = pkg_resources.get_distribution("newslynx").version
# The full version, including alpha/beta/rc tags.
release = pkg_resources.get_distribution("newslynx").version
...
latex_documents = [
    ('index', 'newslynx.tex', u'newslynx Documentation',
...
texinfo_documents = [
    ('index', 'newslynx', u'newslynx Documentation',
     u'Brian Abelson', 'newslynx', 'Own your analytics.',
     'Miscellaneous'),
]
